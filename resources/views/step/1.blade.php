    ...
    <div class="row">
      <div class="col-12 col-sm-6">
        ...
        <div class="btn-group btn-group-toggle btn-group-special space" data-toggle="buttons" style="display: flex; ">
          ...
          <label class="btn btn-info text-center space" style="flex: 1">
            <input type="submit" name="size_option" value="datang" autocomplete="off">
            <span class="text-lg">Datang ke Rahmat Jeans</span>
          </label>
        </div>
        <div class="mt-4">
    ...
    <div class="modal-content">
      <form method="POST" action="{{ route('calons.update', $order) }}">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="customSizeLabel">Input Ukuran Atasan</h5>
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Lebar Bahu</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['lebar_bahu']">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Panjang Lengan - Baju Pendek</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['lengan_pendek']">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Panjang Lengan - Baju Panjang</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['lengan_panjang']">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Lebar Badan</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['lebar_badan']">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Panjang Badan</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['panjang_badan']">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-6 col-form-label">Lebar Lengan</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="keterangan['lebar_lengan']">
            </div>
          </div>
        </div>
